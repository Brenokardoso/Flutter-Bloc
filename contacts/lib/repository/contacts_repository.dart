...
class ContactRepository{
  ...
  Future<List<ContactModel>> findAll() async{
    final response = await Dio().get("http://10.0.2.2:3031/contacts"); // testar também com "http://10.0.2.2:3031/contacts"
    return response.data?.map<ContactModel>((contato)=> ContactModel.fromMap(contato)).toList();
  }
